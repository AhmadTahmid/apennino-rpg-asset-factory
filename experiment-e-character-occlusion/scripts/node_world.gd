...
const OCCLUSION_ANCHOR := Vector2(704, 675)
var occluder_polygon := PackedVector2Array([
	Vector2(668, 645), Vector2(681, 638), Vector2(697, 640),
	Vector2(710, 648), Vector2(720, 661), Vector2(722, 676),
	Vector2(717, 691), Vector2(708, 703), Vector2(691, 706),
	Vector2(677, 697), Vector2(669, 684), Vector2(665, 663)
])
...
func _draw() -> void:
	...
	draw_polyline(occluder_polygon + PackedVector2Array([occluder_polygon[0]]), Color(1.0, 0.25, 0.86, 1.0), 2.0)
	draw_circle(OCCLUSION_ANCHOR, 5.0, Color(1.0, 0.25, 0.86, 1.0))
...
func apply_test_mutation(mutation: String) -> void:
	match mutation:
		...
		"swap_left_right_rows":
			$Player.swap_left_right_rows = true
		"occluder_below_player":
			$ForegroundOccluder.z_index = 5
		"occluder_shift_x20":
			$ForegroundOccluder.position.x += 20.0
		"full_rectangle_mask":
			$ForegroundOccluder.texture = $Background.texture
		"", "none":
			pass
		_:
